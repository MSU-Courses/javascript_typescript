...
В данном контексте **"развернуть"** означает взять каждый элемент массива arr и использовать его как отдельный аргумент
...
> [!TIP]
> **Spread-оператор** применяется не только к массивам, но и к другим типам данных, таких как объекты и др. Мы рассмотрим это более подробно, когда будем изучать соответствующую тему.
