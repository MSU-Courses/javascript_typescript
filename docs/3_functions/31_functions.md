...
> [!NOTE]
> Ключевое слово `return` может быть размещено в любом месте тела функции, не обязательно в его последней строке. Когда интерпретатор встречает это ключевое слово, он мгновенно завершает выполнение функции и возвращает указанное значение.
